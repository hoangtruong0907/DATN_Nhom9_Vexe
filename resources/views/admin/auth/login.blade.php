            ...
            <div class="card">
                <div class="card-body text-center">
                    <div class="mb-4 d-flex justify-content-center align-items-center overflow-hidden">
                        <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ asset('/template/admin/assets/images/logo.png ') }}"alt="bootstraper logo">
                    </div>
                    ...
                    <p class="mb-0 text-muted">Bạn chưa có tài khoản? <a href="signup.html">Đăng ký ngay</a></p>
                </div>
            </div>
        </div>
    </div>
